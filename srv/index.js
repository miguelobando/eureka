...
export default (app) => {
  ...
  const listaDeDatos = require('./models/etapa2/listaDeDatos.json');
  const integracionDeDatos = require('./models/etapa2/integracionDeDatos.json');
  const fuentesEnBasesDeDatos = require('./models/etapa2/fuentesEnBasesDeDatos.json');
  const integracionAWekaBD = require('./models/etapa2/integracionAWekaBD.json');
  ...
  engine.addRule(listaDeDatos);
  engine.addRule(integracionDeDatos);
